...
conversationsRouter.post('/', userController.authenticateToken, conversationsController.createNewMessage) // create new message, and use existing conversation or create new conversation if it doesn't exist
